...
const SignUpUserPasswordCheck = ({signupUserFormData, setSignupUserFormData, secondPassword, setSecondPassword, setIsPasswordValid, isPasswordValid}:SignUpUserPasswordCheckProps) => {
  // 비밀번호 중복 체크 로직
  ...
  return (
    <StyleSignUpInputDiv>
      <label htmlFor="userpasswordcheck">비밀번호 확인</label>{isPasswordValid ? <span>비밀번호가 일치합니다.</span> : null}
      <br />
      <input
        type="password"
