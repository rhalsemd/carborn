...
import Insurance from "./components/MyPage/InsuranceContent";
...
import MyCommunity from "./components/MyPage/MyCommunityContent";
...
const routes = [
  ...
  { path: "/:userid/mypage/community", element: <MyCommunity /> },
