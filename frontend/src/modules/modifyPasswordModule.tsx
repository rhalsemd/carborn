...
export const COMPANY_MODIFY_PASSWORD_REQUEST = 'COMPANY_MODIFY_PASSWORD_REQUEST';
export const COMPANY_MODIFY_PASSWORD_SUCCESS = 'COMPANY_MODIFY_PASSWORD_SUCCESS';
export const COMPANY_MODIFY_PASSWORD_RESET = 'COMPANY_MODIFY_PASSWORD_RESET';

// 액션 생성 함수
export const userModifyPasswordRequest = ({oldPassword, newPassword}:any) => ({
...
export const companyModifyPasswordRequest = ({oldPassword, newPassword}:any) => ({
...
export function* companyModifyPasswordSaga(action:any): Generator<any, any, any> {
  try {
