...
const TermsOfUse = () => {
  ...
  useEffect(() => {
    ...
    onCheckBox();
  }, [dispatch, termsOfUse.website, termsOfUse.privacy, isChecked1, isChecked2])
      ...
      <StyleLoginSignUpBoxDiv>
        ...
        <StyleLoginSignUpTitle>
          <StyleTermsOfUseTitleDiv>
            ...
            <div>
              <input type="checkbox" id="allcheckbox" checked={isCheckedAll} onChange={handleCheckAll}/><span>전체동의</span>
            </div>
          </StyleTermsOfUseTitleDiv>
        </StyleLoginSignUpTitle>
        <StyleTermsOfUseDiv>
        ...
        <StyleLoginSignUpBtn disabled={isButtonDisabled(isChecked1, isChecked2)} onClick={handleSignUp}>회원가입 하기</StyleLoginSignUpBtn>
      </StyleLoginSignUpBoxDiv>
    </StyleLoginSignUpDiv>
  )
}
