...
import { StyleLoginSignUpBoxDiv, StyleLoginSignUpBtn } from "./Login";
import { StyleLoginSignUpDiv } from './PasswordResetCheck';
import { StyleLoginSignUpTitle } from '../auth/SearchID'
...
const PasswordReset = () => {
  ...
  const selector = useSelector(
    (state: { newpasswordcheck: boolean }) => state.newpasswordcheck
  );
